...
public class Graph {
    ...
    public Graph(int initialSize) {
        nodes = new String[initialSize]; // Initialize the nodes array with a default size
        adjacencyList = new boolean[initialSize][initialSize]; // Initialize the adjacency matrix
